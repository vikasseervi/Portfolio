        ...
        <div id='home' className='hero'>
            <div className='container'>
                ...
                <div className='left-half'>
                    ...
                    <h1 className='text-slide-in line1'>  Hi,👋 <span className='gradient-text'> I&apos;m Vikas Seervi </span>, a software engineer passionate about full-stack development and always eager to learn new things!</h1>
                    {/* <h1 className='text-slide-in line2'>  </h1>
                    <h1 className='text-slide-in line3'> </h1> */}
                </div>
            </div>
            <div className >
                <div className='text-slide-up hero-resume' onClick={() => window.open('https://drive.google.com/file/d/1aQNpxVM9gGBN7DOEWG_S5mov1qB39n_O/view?usp=drive_link', '_blank')}> My Resume</div>
